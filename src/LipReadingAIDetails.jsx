...
export default function LipReadingAIDetails({ project, onBack }) {
  ...
  const guideSteps = [
    ...
    { id: 6, title: 'चरण 6: एक्यूरेसी टेस्टिंग', subtitle: 'Validation', icon: Shield, color: 'var(--text-muted)' },
  ];
  ...
  if (showFullscreenFlowchart) {
    return (
      <div className="fullscreen-flow-view" style={{ padding: '2rem', background: 'var(--icon-bg)', minHeight: '100vh', width: '100%' }}>
        ...
        <h3 style={{ textAlign: 'center', marginBottom: '3rem', fontSize: '1.75rem', color: 'var(--text-main)' }}>Lip-Reading AI Architecture</h3>
