...
export default function CDRSemanticSearchDetails({ project, onBack }) {
  ...
  const guideSteps = [
    ...
    { id: 6, title: 'चरण 6: सुरक्षा और टेस्टिंग', subtitle: 'Testing & Security', icon: Shield, color: 'var(--text-muted)' },
  ];
  ...
  if (showFullscreenFlowchart) {
    return (
      <div className="fullscreen-flow-view" style={{ padding: '2rem', background: 'var(--icon-bg)', minHeight: '100vh', width: '100%' }}>
        ...
        <h3 style={{ textAlign: 'center', marginBottom: '3rem', fontSize: '1.75rem', color: 'var(--text-main)' }}>CDR Analysis Architecture</h3>
