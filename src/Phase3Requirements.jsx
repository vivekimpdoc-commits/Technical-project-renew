      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '1.5rem' }}>
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>Suggested Tech Stack (.NET + AI)</h3>
          </div>
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>Frontend Deliverables</h3>
          </div>
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>Project Structure (फोल्डर)</h3>
          </div>
          <pre style={{ margin: 0, padding: '1.25rem', background: 'var(--icon-bg)', borderRadius: '0.75rem', border: '1px dashed #cbd5e1', fontSize: '0.9rem', color: 'var(--text-main)', fontFamily: 'monospace', lineHeight: '1.5' }}>
            {`Frontend
│
├── Components
├── Pages
...
└── Routes`}
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>API Integration Flow</h3>
          </div>
