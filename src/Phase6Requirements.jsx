      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>Cloud Deployment Flow</h3>
          </div>
          
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', alignItems: 'center' }}>
            <div style={{ background: 'var(--icon-bg)', color: 'var(--text-main)', padding: '0.5rem 1.5rem', borderRadius: '2rem', fontWeight: 'bold', border: '1px solid var(--card-border)' }}>Police User (Web/App)</div>
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>Deployment Tools Stack</h3>
          </div>
