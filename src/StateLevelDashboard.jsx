...
export default function StateLevelDashboard() {
  ...
  return (
    <div className="thane-dashboard-container" style={{ width: '100%' }}>
      ...
      {activeTab === 'overview' && (
        <div className="animate-fade-in">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
            <div style={{ background: 'var(--card-bg)', padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--card-border)', borderLeft: '4px solid #3b82f6', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
              <div style={{ color: 'var(--text-muted)', fontSize: '0.9rem', fontWeight: '600', marginBottom: '0.5rem' }}>TOTAL ACTIVE CASES (STATE)</div>
              <div style={{ fontSize: '2.5rem', fontWeight: '800', color: 'var(--text-main)' }}>12,450</div>
            ...
            <div style={{ background: 'var(--card-bg)', padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--card-border)', borderLeft: '4px solid #10b981', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
              <div style={{ color: 'var(--text-muted)', fontSize: '0.9rem', fontWeight: '600', marginBottom: '0.5rem' }}>AI RESOLUTION RATE</div>
              <div style={{ fontSize: '2.5rem', fontWeight: '800', color: 'var(--text-main)' }}>76.4%</div>
            ...
            <div style={{ background: 'var(--card-bg)', padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--card-border)', borderLeft: '4px solid #f59e0b', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
              <div style={{ color: 'var(--text-muted)', fontSize: '0.9rem', fontWeight: '600', marginBottom: '0.5rem' }}>CYBER THREATS INTERCEPTED</div>
              <div style={{ fontSize: '2.5rem', fontWeight: '800', color: 'var(--text-main)' }}>342</div>
            ...
            <div style={{ background: 'var(--card-bg)', padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--card-border)', borderLeft: '4px solid #8b5cf6', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
              <div style={{ color: 'var(--text-muted)', fontSize: '0.9rem', fontWeight: '600', marginBottom: '0.5rem' }}>ACTIVE FIELD PERSONNEL</div>
              <div style={{ fontSize: '2.5rem', fontWeight: '800', color: 'var(--text-main)' }}>45,210</div>
          ...
          <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
              <div style={{ padding: '1rem', background: 'var(--icon-bg)', borderRadius: '0.5rem', border: '1px solid var(--card-border)' }}>
                <div style={{ fontWeight: '700', color: 'var(--text-main)', marginBottom: '0.5rem' }}>Macro Resource Allocation</div>
                <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>AI calculates the optimal distribution of vehicles, weapons, and specialized units across districts based on predictive threat models.</div>
              </div>
              <div style={{ padding: '1rem', background: 'var(--icon-bg)', borderRadius: '0.5rem', border: '1px solid var(--card-border)' }}>
                <div style={{ fontWeight: '700', color: 'var(--text-main)', marginBottom: '0.5rem' }}>Statewide Pattern Recognition</div>
                <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>Detecting organized crime syndicates that operate across multiple district borders by linking seemingly unrelated FIRs.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {activeTab === 'districts' && (
        <div className="animate-fade-in" style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <h3 style={{ margin: '0 0 1.5rem 0', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <tbody>
                {districts.map((d, i) => (
                  <tr key={i} style={{ borderBottom: '1px solid #f1f5f9' }}>
                    ...
                    <td style={{ padding: '1rem', color: 'var(--text-muted)' }}>{d.activeCases}</td>
                    <td style={{ padding: '1rem', color: 'var(--text-muted)' }}>{d.aiResolved}</td>
      ...
      {activeTab === 'intelligence' && (
        <div className="animate-fade-in" style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem', background: 'var(--icon-bg)', borderRadius: '0.5rem', border: '1px dashed #cbd5e1' }}>
