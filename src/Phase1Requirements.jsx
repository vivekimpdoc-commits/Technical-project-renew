    ...
    <div className="thane-dashboard-container" style={{ padding: '2rem', background: 'var(--icon-bg)', minHeight: '100vh', width: '100%' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <div>
          ...
          <p style={{ margin: '0.25rem 0 0 0', color: 'var(--text-muted)' }}>ज़रूरतों को समझना और विश्लेषण - Detailed breakdown of all requirements</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '1.5rem' }}>
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>Requirements Gathering Process (चरण)</h3>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {processList.map((step, idx) => (
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '0.75rem 1rem', background: 'var(--icon-bg)', borderRadius: '0.5rem', border: '1px solid #f1f5f9' }}>
                ...
                <span style={{ color: 'var(--text-main)', fontWeight: '500' }}>{step}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.25rem', color: 'var(--text-main)' }}>Deliverables (अंतिम दस्तावेज)</h3>
          </div>
