      ...
      <div style={{ background: 'var(--card-bg)', borderRadius: '1rem', padding: '2rem', border: '1px solid var(--card-border)', marginTop: '2rem', boxShadow: '0 10px 25px -5px rgba(0,0,0,0.05)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '3rem', position: 'relative' }}>
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 1, background: 'var(--card-bg)', padding: '0 1rem' }}>
              <div style={{ 
        ...
        {/* Simulation Window */}
        <div style={{ background: 'var(--icon-bg)', border: '1px solid var(--card-border)', borderRadius: '0.75rem', padding: '2rem', minHeight: '300px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
          
          {step === 0 && (
            <div style={{ textAlign: 'center' }}>
              <Mic size={48} color="#94a3b8" style={{ margin: '0 auto 1rem auto' }} />
              <h3 style={{ color: 'var(--text-main)', marginBottom: '0.5rem' }}>Ready for Voice Input</h3>
          ...
          {step === 1 && (
            <div className="animate-pulse" style={{ textAlign: 'center' }}>
              ...
              <div style={{ background: 'var(--card-bg)', padding: '1rem', borderRadius: '0.5rem', border: '1px solid var(--card-border)', fontStyle: 'italic', color: 'var(--text-main)', display: 'inline-block' }}>
                "कल रात को 10 बजे किसी ने मेरी बाइक (UP32 AA 1234) मेरे घर के सामने से चुरा ली है। मैंने सुबह देखा तो वह नहीं थी।"
              </div>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '1rem' }}>Capturing and translating Hindi audio...</p>
            </div>
          )}
          ...
          {step === 2 && (
            <div style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ color: 'var(--text-main)', marginBottom: '0.5rem' }}>AI Brain is Processing...</h3>
              <ul style={{ textAlign: 'left', display: 'inline-block', color: 'var(--text-muted)', fontSize: '0.9rem', background: 'var(--card-bg)', padding: '1rem 2rem', borderRadius: '0.5rem', border: '1px solid var(--card-border)' }}>
          ...
          {step === 3 && (
            <div className="animate-fade-in" style={{ width: '100%' }}>
              ...
              <div style={{ background: 'var(--card-bg)', padding: '1.5rem', borderRadius: '0.5rem', border: '1px solid var(--card-border)', textAlign: 'left' }}>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: '1.6', marginTop: '0.5rem' }}>
                ...
                <div style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem', justifyContent: 'flex-end' }}>
                  <button style={{ background: 'var(--icon-bg)', color: 'var(--text-main)', padding: '0.5rem 1rem', borderRadius: '0.5rem', border: '1px solid var(--card-border)', cursor: 'pointer' }} onClick={handleReset}>Reset Demo</button>
